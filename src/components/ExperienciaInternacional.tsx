          ...
          <div className="container">
            <div className="row">
              <div className="col text-center">
                <h2 className="fw-bold mb-4"><i className="bi bi-award me-2 text-primary"></i>Experiencia Internacional</h2>
                ...
                <div className="d-flex flex-wrap justify-content-center gap-2"> {/* Use flexbox for badges */}
                  <span className="badge bg-secondary text-body-emphasis rounded-pill px-3 py-3">Alimentos (Bebidas, Café, Té, Galletas, Snacks)</span> {/* Changed badge style */}
